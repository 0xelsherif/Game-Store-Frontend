    ...
    <div class='flex flex-wrap w-full items-center'>
      ...
      <div class="ml-auto max-lg:mt-4">
        ...
        <ul class='flex items-center'>
          ...
          <li class='max-sm:hidden flex text-[15px] max-lg:py-2 px-3 font-medium text-[#333] cursor-pointer'>
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="mr-2" viewBox="0 0 512 511">
              <path
          ...
          <li class='max-lg:py-2 px-3 cursor-pointer'>
            <span class="relative">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="inline" viewBox="0 0 512 512">
                <path
