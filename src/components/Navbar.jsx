...
const Navbar = () => {
  return (
    <header class="shadow-md font-[sans-serif] tracking-wide relative z-50">
      <section class="md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-900 border-b bg-gray-900 lg:min-h-[80px] max-lg:min-h-[60px]">
        <a href="javascript:void(0)" class="max-sm:w-full max-sm:mb-3 shrink-0">
          <img src="src/images/logo.png" alt="logo" class="w-[180px]" />
        </a>

        <div class="flex flex-wrap w-full items-center">
          <div className="w-full max-w-xs xl:max-w-lg 2xl:max-w-xl bg-gray-400 rounded-md hidden xl:flex items-center text-sm p-4 mr-4">
        ...
        <ul class="lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-gray-800 min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
          ...
          <li class="max-lg:border-b max-lg:py-3 px-3">
            <a
              ...
              class="hover:text-yellow-500 text-yellow-500 text-[15px] font-medium block"
            >
              New
            </a>
          </li>
          <li class="max-lg:border-b max-lg:py-3 px-3">
            <a
              href="javascript:void(0)"
              class="hover:text-yellow-500 text-white text-[15px] font-medium block"
            >
              Brands
            </a>
          </li>
